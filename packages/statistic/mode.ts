 ...
 * @param {string | ((item: T, index: number | undefined, arr: T[]) => any)} [getter] @zh 提供区分元素的标识 @en Provide an identifier to distinguish the elements
 * @returns {any[]}
 * @version 0.0.1
 * @example
 * ```ts
...
export function mode<T>(
  data: T[],
  getter?: string | ((item: T, index: number | undefined, arr: T[]) => any)
) {
