...
const createDocsTemplate = (moduleName, functionName) => {
  ...
  languages.forEach(language => {
    const languagePath = path.join(docsDir, language);
    const moduleDocsPath = path.join(languagePath, moduleName);
...
(async () => {
  try {
    ...
    console.log(`🎉Successfully created the function template and documentation template for ${moduleName}/${functionName}`);
  } catch (error) {
